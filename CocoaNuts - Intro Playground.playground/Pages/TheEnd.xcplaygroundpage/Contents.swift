...
//:
//: Hopefully you now have a better idea of what Swift is all about and are motivated to learn even more about Swift and iOS in the future.
//:
//: ## What should I do now?
//:
//: If you want to do some more coding, then I would suggest, in no specific order, the following:
//:
